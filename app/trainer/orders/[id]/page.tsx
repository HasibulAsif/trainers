...
import TrainerOrderDetail from "./trainer-order-detail"

export default async function TrainerOrderDetailPage({ params }: { params: { id: string } }) {
  const { id } = params
    ...
    if (DEV_MODE) {
      ...
      const mockOrders = {
        ...
        "order-4": {
          ...
          has_meal_plan: true,
          has_workout_plan: true,
          description: "Complete fitness transformation package with personalized workout, nutrition, and meal plans.",
          nutrition_plan: null,
          meal_plan: null,
          workout_plan: null,
        },
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      {error ? (
        ...
        <TrainerOrderDetail order={order} />
      )}
    </div>
  )
}
