...
export default function TrainerNotificationsPage() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      setLoading(true)
      const data = await getNotifications(trainerId, "trainer")
  ...
  const handleMarkAllAsRead = async () => {
    await markAllNotificationsAsRead(trainerId, "trainer")
        ...
        <main className="p-6">
          <div className="mb-6 flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Stay updated with your training business</p>
            </div>
